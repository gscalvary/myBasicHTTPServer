...
public class ServletResponse implements SimpleServletResponse{
    ...
    public ServletResponse(OutputStream outputStream, ServletRequest request) {
    ...
    public void sendResource() {
        ...
        File file = new File(Engine.RESOURCE_DIRECTORY, request.getUrlPath().toLowerCase());
        ...
        try(FileInputStream fileInputStream = new FileInputStream(file);
            ...
            setMimeType(interpretMIMEType(request.getUrlPath()));
     ...
     */
    private String interpretMIMEType(String resource) {
